...
<body class="bg-yellow-200 text-gray-200">
  <nav class="fixed top-0 left-0 right-0 z-50 bg-red-800 bg-opacity-90 py-4 px-6 flex justify-between items-center shadow-md">
    <a href="#" class="text-2xl font-bold italic text-white">
     Gera<span class="text-yellow-500">Dimsum</span>
    </a>
  ...
  <div class="container mx-auto mt-32 px-4 md:ml-72">
    <h1 class="text-3xl font-bold text-red-800 mb-6">Daftar Pesanan</h1>
