...
<body class="bg-yellow-200 text-white font-poppins">
  <nav class="fixed top-0 left-0 right-0 z-50 bg-red-800 bg-opacity-80 py-4 px-6 flex justify-between items-center border-b border-gray-700">
    <a href="#" class="text-2xl font-bold italic text-white">Gera<span class="text-yellow-500">Dimsum</span></a>
  ...
  <aside class="fixed top-0 h-full w-64 bg-white text-black shadow-lg z-50 md:hidden sidebar" id="sidenav">
    ...
    <a href="orders.php" class="hover:bg-yellow-100 py-2 px-8">Orders</a>
    <a href="transactions.php" class="hover:bg-yellow-100 py-2 px-8">transactions</a>
    </nav>
  </aside>
  ...
  <div id="menu-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center px-12 z-50 opacity-0 pointer-events-none transition-opacity duration-500 ease-in-out">
    <form action="../../controllers/AddMenuController.php" method="POST" enctype="multipart/form-data" class="relative bg-white/60 backdrop-blur-lg p-6 rounded-lg shadow-lg w-full max-w-md">
      ...
      <label for="menu-name" class="block mt-2">Menu Name</label>
      ...
      <label for="price" class="block mt-4">Price</label>
  ...
  <section class="absolute left-8 md:left-72 top-32">
    <h3 class="text-2xl font-bold mb-4 text-red-500 mb-6">Menu</h3>
    <p class="text-red-500 mb-6">Menu yang tersedia</p>
