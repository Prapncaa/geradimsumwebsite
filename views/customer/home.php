...
<body class="bg-yellow-200 text-white font-poppins">
  ...
  <aside class="fixed top-0 h-full w-64 bg-yellow-100 text-black shadow-lg z-50 md:hidden sidebar" id="sidenav">
  ...
  <section class="absolute left-8 md:left-72 top-32">
    <h3 class="text-2xl font-bold mb-4 text-red-800">Menu</h3>
    <p class="text-red-800 mb-6">Menu yang tersedia</p>
